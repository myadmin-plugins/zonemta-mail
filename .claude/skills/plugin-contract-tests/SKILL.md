...
The class under contract here is `Detain\MyAdminZoneMTAMail\Plugin`.
...
- This package declares `$module = 'mail'`. Changing it detaches the plugin from the events core dispatches to it, so the generated pin asserts it.
